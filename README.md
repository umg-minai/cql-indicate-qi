...
1. The CQL libraries are written based on the [OMOP Clinical Data Model](https://www.ohdsi.org/data-standardization/) version 5.4 and therefore must be applied to clinical data which conforms to that data model.
